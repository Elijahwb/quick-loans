            ...
            <div class="container py-3 2xl:py-5 z-3 px-5">
                ...
                <div class="text-[#768599] bg-white rounded-md overflow-hidden my-7 lg:my-14">
                    <div class="flex justify-between items-center py-2 lg:py-4 px-4 border-b border-gray-400">
                        <div>What are the costs?</div>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" class="text-brand-900 h-3.5 lg:h-5 2xl:h-6 lg:w-5 2xl:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                            </svg>
                        </div>
                    </div>
                    <div class="flex justify-between items-center py-2 lg:py-4 px-4 border-b border-gray-400">
                        <div>What you need to aquire a loan?</div>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" class="text-brand-900 h-3.5 lg:h-5 2xl:h-6 lg:w-5 2xl:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                            </svg>
